...
module.exports = {
  ...
  addQuestion : async (req, res, next) => {
    try {
      const user = await UserServices.addQuestion(req.body.employee_id, req.body.department_id, req.body.question_text, req.body.is_anonymus, req.body.date_created, req.body.date_last_modifed, req.body.like_count, req.body.comment_count, req.body.is_answer);
